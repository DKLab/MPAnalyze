...
function displayWidthChange(handles, changeInWidth)
    ...
    set(handles.edit_regionWidth_px, 'String', widthString);
...
smallLabelWidth = 20 / panel_bounds(3);

editWidth = 30 / panel_bounds(3);
editHeight = 20 / panel_bounds(4);
editX = labelX - (labelWidth - editWidth)/3;
...
handles.label_regionWidth_px = uicontrol(...
    ...
    'Style', 'text',...
    'Units', 'normalized',...
    'Position', [ editX + editWidth, 0.62, smallLabelWidth, labelHeight ],...
    'Tag','activeRegionControl',...
    'String', 'px',...
    'Enable','off' );

mvX = labelX + labelWidth - (labelWidth - editWidth)/2;
handles.edit_regionWidth_mv = uicontrol(...
    'Parent', handles.panel_controls,...
    'Style', 'edit',...
    'Units', 'normalized',...
    'Position', [ mvX, 0.65, editWidth, editHeight ],...
    'Tag','activeRegionControl',...
    'String', '',...
    'Enable','off' );
...
handles.label_regionWidth_mv = uicontrol(...
    ...
    'Style', 'text',...
    'Units', 'normalized',...
    'Position', [ mvX + editWidth, 0.62, smallLabelWidth, labelHeight ],...
    'Tag','activeRegionControl',...
    'String', 'mv',...
    'Enable','off' );
